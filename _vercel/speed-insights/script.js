      ...
      (s = function () {
        ...
        (C = function (e) {
          "hidden" === document.visibilityState &&
            L > -1 &&
            ((L = "visibilitychange" === e.type ? e.timeStamp : 0), x());
        }),
        (M = function () {
        ...
        (q = function (e, t) {
          i ||
            ((i = t), (a = e), (o = new Date()), V(removeEventListener), H());
        }),
        (H = function () {
          if (a >= 0 && a < o - N) {
            var e = {
              ...
              var e,
                ...
                a = function (n) {
                  ...
                  r &&
                    ...
                    ((i.value = Math.max(r.startTime - h(), 0)),
                    (i.entries = [r]),
                    e());
                },
    ...
    ef(),
      ...
      (function () {
              ...
              (ep(
                {
                  ...
                  sdkName:
                    null !=
                    (n = null == i ? void 0 : i.getAttribute("data-sdkn"))
                      ? n
                      : void 0,
                  sdkVersion:
                    null !=
                    (r = null == i ? void 0 : i.getAttribute("data-sdkv"))
                      ? r
                      : void 0,
                },
                o
        ...
        (() => {
          ...
          window.sil = !0;
          let r = Number(
            null != (t = null == i ? void 0 : i.dataset.sampleRate) ? t : 1
          );
